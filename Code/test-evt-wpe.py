...
class ConfusionMatrix(object):
    ...
    def plot(self):
        ...
        plt.savefig('evt_wpe.png', dpi=300)
        plt.show()
...
def plot_image_grid(images, figsize=(15, 15)):
    ...
    plt.tight_layout()
    plt.savefig("./show_test2.png", dpi=300, bbox_inches='tight')
    plt.close(fig)
...
if __name__ == '__main__':
    ...
    model_weight_path = "evt-1015.pth"
    ...
    for i, val_data in enumerate(validate_loader):
        ...
        cv2.imwrite('test2_{}.png'.format(i), superimposed_img, [int(cv2.IMWRITE_PNG_COMPRESSION), 9, int(cv2.IMWRITE_PNG_BILEVEL), 0])
        # 将结果保存到列表中
