...
def main():
    ...
    train_dataset = datasets.ImageFolder(root=r'', transform=augmentations)
    print(train_dataset.root)
    print(os.listdir(train_dataset.root))
    # train_dataset = datasets.ImageFolder(root=r'C:\Users\20926\Desktop\breast\breakhis_demo', transform=augmentations)
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)
    # val_dataset = datasets.ImageFolder(root=r'D:\Desktop\breast\new_dataset\val',transform=transforms.Compose([
    #         transforms.Resize((224, 224)),
    #         transforms.ToTensor(),
    #         *normalize,
    #     ]))
    
    val_dataset = datasets.ImageFolder(root=r'../BreaKHis',transform=transforms.Compose([
            transforms.Resize((224, 224)),
            transforms.ToTensor(),
            *normalize,
        ]))
    ...
    torch.save(model.state_dict(), './evt.pth')
